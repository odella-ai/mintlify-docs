...
description: "Understand the AI Employee profile, availability control, connected applications, and management areas."
---
...
1. **Header** — breadcrumbs and the worker availability control.
...
The availability control starts or pauses the worker.
...
| **Actions** | Start work from configured events in connected applications. |
| **Workspace** | Manage the worker's private working files and folders. |
| **Activity Log** | Review worker activity such as threads, workflows, tasks, service checks, and delegated work. |
| **Identity** | Edit profile details, manager, personality, and general instructions. |
| **Settings** | Configure models, memory, working hours, security, billing, and termination settings. |
