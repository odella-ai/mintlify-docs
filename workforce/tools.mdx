...
Tools let a worker read information or perform approved actions in connected systems.
...
Tool behavior is governed by the worker's **Tool approval policy** in Settings.
