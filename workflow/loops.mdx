---
title: 'Loops'
description: 'Using loops in Odella workflows'
---

<Callout type="info">
  Loops repeat a defined set of workflow steps. Use them when items must be processed sequentially or execution depends on an explicit completion condition.
</Callout>
