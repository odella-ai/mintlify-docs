...
<Frame>
  <img
    src="../assets/plugin-settings.png"
    alt="Plugin Settings"
  />
</Frame>
...
<Frame>
  <img
    src="../assets/workflow-application-usage.png"
    alt="Using Application in Workflow"
  />
</Frame>
