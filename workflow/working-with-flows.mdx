...
<Frame className="block dark:hidden">
  <img src="../assets/workflows_new_light.gif" alt="Workflow Creation Process (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="../assets/workflows_new_dark.gif" alt="Workflow Creation Process (Dark Mode)" />
</Frame>
...
<Frame className="block dark:hidden">
  <img src="../assets/workflows_delete_light.gif" alt="Workflow Deletion Process (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="../assets/workflows_delete_dark.gif" alt="Workflow Deletion Process (Dark Mode)" />
</Frame>
...
<Frame className="block dark:hidden">
  <img src="../assets/workflows_run_light.gif" alt="Workflow Running Process (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="../assets/workflows_run_dark.gif" alt="Workflow Running Process (Dark Mode)" />
</Frame>
