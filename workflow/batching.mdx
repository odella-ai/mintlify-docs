---
title: "Batching"
description: "Learn how to process multiple documents or tasks at once in Odella workflows"
---
...
<Frame>
  <img src="../assets/workflows_batch_light.gif" alt="Workflow Batching (Light Mode)" className="block dark:hidden" />
  <img src="../assets/workflows_batch_dark.gif" alt="Workflow Batching (Dark Mode)" className="hidden dark:block" />
</Frame>
...
To use batching in Odella, you simply:
...
<Frame>
  <img src="../assets/batch_example_light.gif" alt="Workflow Batching (Light Mode)" className="block dark:hidden" />
  <img src="../assets/batch_example_dark.gif" alt="Workflow Batching (Dark Mode)" className="hidden dark:block" />
</Frame>
...
<Steps>
  ...
  4. Odella processes all contracts simultaneously
