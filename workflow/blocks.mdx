...
![Adding a block](/snippets/block_add.gif)
...
![Moving a block](/snippets/block_move.gif)

## Deleting Blocks

Right-click on a block and select **Delete** to remove it from the flow.
![Deleting a block](/snippets/block_delete.gif)
...
For more on editing blocks, visit the [Interface Overview](./overview-of-interface).

---

With these tools and tips, you're ready to create dynamic, organised workflows in Lawme. Explore the various components and configurations to find what works best for your legal needs.
