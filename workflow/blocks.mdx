...
<Frame className="block dark:hidden">
  <img src="/assets/block_add_light.gif" alt="Adding a block (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/assets/block_add_dark.gif" alt="Adding a block (Dark Mode)" />
</Frame>
...
<Frame className="block dark:hidden">
  <img src="/assets/block_move_light.gif" alt="Moving a block (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/assets/block_move_dark.gif" alt="Moving a block (Dark Mode)" />
</Frame>
...
<Frame className="block dark:hidden">
  <img src="/assets/block_delete_light.gif" alt="Deleting a block (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/assets/block_delete_dark.gif" alt="Deleting a block (Dark Mode)" />
</Frame>
...
<Frame className="block dark:hidden">
  <img src="/assets/block_connect_light.gif" alt="Connecting a block (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/assets/block_connect_dark.gif" alt="Connecting a block (Dark Mode)" />
</Frame>
...
<Frame className="block dark:hidden">
  <img src="/assets/block_create_subflow_light.gif" alt="Creating a subflow (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/assets/block_create_subflow_dark.gif" alt="Creating a subflow (Dark Mode)" />
</Frame>
...
<Frame className="block dark:hidden">
  <img src="/assets/block_edit_light.gif" alt="Editing a block (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/assets/block_edit_dark.gif" alt="Editing a block (Dark Mode)" />
</Frame>
