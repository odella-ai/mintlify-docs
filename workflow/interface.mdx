...
<CardGroup cols={2}>
  <Card
    ...
    icon="play"
  >
    Lawme automatically saves your work before you run a workflow, ensuring your changes are always protected when executing your flows.
  </Card>
  <Card
    title="Manual Save"
    icon="floppy-disk"
...
<Frame>
  <img src="/block-reference/assets/sidebar_light.png" alt="Sidebar (Light Mode)" className="block dark:hidden" />
  <img src="/block-reference/assets/sidebar_dark.png" alt="Sidebar (Dark Mode)" className="hidden dark:block" />
</Frame>
