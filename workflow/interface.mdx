...
<Frame>
  <img src="assets/workflow_sidebar_light.png" alt="Sidebar (Light Mode)" className="block dark:hidden" />
  <img src="assets/workflow_sidebar_dark.png" alt="Sidebar (Dark Mode)" className="hidden dark:block" />
</Frame>
