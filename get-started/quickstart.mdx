...
<Frame>
  <video autoPlay muted loop playsInline preload="auto" controls width="100%" src="../assets/videos/getstarted.mp4"></video>
</Frame>
...
<Frame>
  <video autoPlay muted loop playsInline preload="auto" controls width="100%" src="../assets/videos/signin.mp4"></video>
</Frame>
...
<Frame>
  <video autoPlay muted loop playsInline preload="auto" controls width="100%" className="dark:hidden" src="../assets/videos/overviewmp4.mp4"></video>
  <video autoPlay muted loop playsInline preload="auto" controls width="100%" className="hidden dark:block" src="../assets/videos/overviewmp4-dark.mp4"></video>
</Frame>
