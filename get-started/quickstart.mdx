...
<CardGroup cols={2}>
  <Card title="Free Up Your Lawyers" icon="user-lawyer">
...
<Card title="Dive into Documentation" icon="book" href="/introduction">
  Discover all the features Lawme has to offer
</Card>
