...
The Templates page is where all your firm's templates live, and where you'll create new ones in seconds. Reach it from the left sidebar.
...
<Steps>
  <Step title="Upload the File">
    Click **Browse files** and select a PDF or DOCX document to use as the starting point — contracts, letters, forms, and other repeatable business documents all work well. Once uploaded, Odella reviews the file and pulls in the basics for the next step. Once a file is selected, it appears with its name, type, and size, with a confirmation check. Click **Continue**.
  </Step>
