---
title: "DOCX Templates for Word Document Automation"
description: "Create DOCX templates from Word precedents using variables, conditionals, loops, and equations for automated document generation in Odella."
---

## Create Your First DOCX Template

Use DOCX templates to turn existing Microsoft Word precedents into reusable document automation templates in Odella. Add variables, conditionals, loops, equations, and image fields so AI Employees can extract information from source materials and generate contracts, letters, correspondence, reports, and other Word documents in your firm's exact format.
