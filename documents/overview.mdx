...
Document Stores are searchable knowledge vaults for your organization. Upload or sync files, extract structured metadata with AI, search across content and columns, and make trusted source material available to workflows and AI Employees.
...
| --- | --- |
| **My Vaults** | Private stores created by your organization. These can be opened, managed, and connected to workers. |
...
<Frame>
  <video autoPlay muted loop playsInline preload="auto" controls width="100%" className="dark:hidden" src="../assets/videos/Vaultindocumentstore.mp4"></video>
  <video autoPlay muted loop playsInline preload="auto" controls width="100%" className="hidden dark:block" src="../assets/videos/Vaultindocumentstore-dark.mp4"></video>
</Frame>
