...
Document Stores are searchable knowledge vaults for your organisation. Upload or sync files, extract structured metadata with AI, search across content and columns, and make reliable source material available to workflows and AI employees.

<CardGroup cols={2}>
  <Card title="Searchable Knowledge Vaults" icon="database">
    Store document collections as organized knowledge bases with table views, metadata, and search.
  </Card>
