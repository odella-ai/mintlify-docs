...
<Steps>
  1. In the sidebar, locate the "Flows" tab with a list of numbered folders containing flows.
  2. Find the folder named "3. Matching and Conditionals".
  3. Open the "Matching and Conditionals" flow.
</Steps>

You should see the following flow:

<Frame>
  <img src="./assets/03-overview.png" alt="Overview of Matching and Conditionals Flow" />
</Frame>

We can use this example NDA generated from the previous tutorial!

<Note>
  This is an example Non-Disclosure Agreement (NDA) that we'll be working with in this tutorial.
</Note>
