---
title: Batching
description: Learn how to process multiple inputs efficiently in Odella
---
...
The Ask AI block demonstrates batching by applying the same prompt to a list of inputs.

<Frame>
  <img src="./assets/06-split-sequence.png" alt="Ask AI Node Batching" />
</Frame>
...
<Frame>
  <img src="./assets/06-split-block-config.png" alt="Split Mode Configuration" />
</Frame>
...
<Frame>
  <img src="./assets/06-split-block-output.png" alt="Batch Output" />
</Frame>
