...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/race_inputs_light.png" alt="Race Inputs Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/race_inputs_dark.png" alt="Race Inputs Block Screenshot" />
</Frame>
