...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/loop_controller_light.png" alt="Loop Controller Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/loop_controller_dark.png" alt="Loop Controller Block Screenshot" />
</Frame>
