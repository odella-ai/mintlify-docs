...
<Frame>
  <img src="/block-reference/assets/switch_light.png" alt="Switch Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/switch_dark.png" alt="Switch Block Screenshot" className="hidden dark:block" />
</Frame>
