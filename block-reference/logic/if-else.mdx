...
<Frame>
  <img src="/block-reference/assets/if_else_light.png" alt="If/Else Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/if_else_dark.png" alt="If/Else Block Screenshot" className="hidden dark:block" />
</Frame>
