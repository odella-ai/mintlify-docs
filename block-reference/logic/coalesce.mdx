...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/coalesce_light.png" alt="Coalesce Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/coalesce_dark.png" alt="Coalesce Block Screenshot" />
</Frame>
