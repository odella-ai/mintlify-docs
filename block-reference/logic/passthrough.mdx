...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/passthrough_light.png" alt="Passthrough Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/passthrough_dark.png" alt="Passthrough Block Screenshot" />
</Frame>
