...
<Frame>
  <img src="/block-reference/assets/passthrough_light.png" alt="Passthrough Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/passthrough_dark.png" alt="Passthrough Block Screenshot" className="hidden dark:block" />
</Frame>
