...
<Frame>
  <img src="/block-reference/assets/delay_light.png" alt="Delay Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/delay_dark.png" alt="Delay Block Screenshot" className="hidden dark:block" />
</Frame>
