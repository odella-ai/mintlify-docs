...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/wait_for_event_light.png" alt="Wait For Event Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/wait_for_event_dark.png" alt="Wait For Event Block Screenshot" />
</Frame>
