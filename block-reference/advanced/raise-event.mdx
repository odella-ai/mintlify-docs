...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/raise_event_light.png" alt="Raise Event Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/raise_event_dark.png" alt="Raise Event Block Screenshot" />
</Frame>
