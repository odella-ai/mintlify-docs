...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/raise_event_block_light.png" alt="Raise Event Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/raise_event_block_dark.png" alt="Raise Event Block Screenshot" />
</Frame>
