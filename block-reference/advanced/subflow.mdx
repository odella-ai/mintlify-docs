...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/subflow_light.png" alt="Subflow Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/subflow_dark.png" alt="Subflow Block Screenshot" />
</Frame>
