...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/comment_block_light.png" alt="Comment Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/comment_block_dark.png" alt="Comment Block Screenshot" />
</Frame>
