...
<Frame>
  <img src="/block-reference/assets/comment_light.png" alt="Comment Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/comment_dark.png" alt="Comment Block Screenshot" className="hidden dark:block" />
</Frame>
