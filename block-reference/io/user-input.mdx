...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/user_input_light.png" alt="User Input Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/user_input_dark.png" alt="User Input Block Screenshot" />
</Frame>
