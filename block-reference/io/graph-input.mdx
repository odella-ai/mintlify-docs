...
<Frame>
  <img src="/block-reference/assets/input_light.png" alt="Input Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/input_dark.png" alt="Input Block Screenshot" className="hidden dark:block" />
</Frame>
...
- [Understanding Data Types](/workflow/data-types)
- [Creating Reusable Subflows](/workflow/subflows)
- [Best Practices for Flow Design](/workflow/overview)
