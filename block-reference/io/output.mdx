...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/output_block_light.png" alt="Output Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/output_block_dark.png" alt="Output Block Screenshot" />
</Frame>
