...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/input_block_light.png" alt="Input Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/input_block_dark.png" alt="Input Block Screenshot" />
</Frame>
