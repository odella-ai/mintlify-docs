...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/confirm_block_light.png" alt="Confirm Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/confirm_block_dark.png" alt="Confirm Block Screenshot" />
</Frame>
