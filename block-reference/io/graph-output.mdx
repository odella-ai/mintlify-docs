---
id: graph-output
title: Flow Output Block for Workflow Results
description: Use the Flow Output block to return workflow results, expose subflow outputs, and pass typed data back from Odella flows.
sidebarTitle: Output
---

<Frame>
  <img src="/block-reference/assets/output_light.png" alt="Output Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/output_dark.png" alt="Output Block Screenshot" className="hidden dark:block" />
</Frame>
