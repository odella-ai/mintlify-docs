...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/ai_filter_light.png" alt="AI Filter Block Screenshot (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/ai_filter_dark.png" alt="AI Filter Block Screenshot (Dark Mode)" />
</Frame>
