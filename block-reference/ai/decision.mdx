...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/decision_light.png" alt="Decision Block Screenshot (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/decision_dark.png" alt="Decision Block Screenshot (Dark Mode)" />
</Frame>
