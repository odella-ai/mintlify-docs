---
id: analyze-image
title: Describe Image Block for AI Image Analysis
description: Use the Describe Image block to analyze images, charts, screenshots, and diagrams with natural language prompts in Odella workflows.
