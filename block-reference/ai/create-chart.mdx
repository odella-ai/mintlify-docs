...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/create_chart_light.png" alt="Create Chart Screenshot (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/create_chart_dark.png" alt="Create Chart Screenshot (Dark Mode)" />
</Frame>
