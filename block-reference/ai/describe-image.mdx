...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/describe_image_light.png" alt="Describe Image Screenshot (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/describe_image_dark.png" alt="Describe Image Screenshot (Dark Mode)" />
</Frame>
