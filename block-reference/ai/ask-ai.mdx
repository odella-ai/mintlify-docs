...
<ParamField path="Model" type="string">
  The specific model to use for the request. Choose from over 250 available models across various providers.
</ParamField>
...
<Note>
  Available settings may vary depending on the selected model.
</Note>
