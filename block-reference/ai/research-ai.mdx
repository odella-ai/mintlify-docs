...
<Frame>
  <img src="/block-reference/assets/research_light.png" alt="Research AI Block Screenshot" className="dark:hidden" />
  <img src="/block-reference/assets/research_dark.png" alt="Research AI Block Screenshot" className="hidden dark:block" />
</Frame>
