...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/extract_data_light.png" alt="Extract Data Block Screenshot (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/extract_data_dark.png" alt="Extract Data Block Screenshot (Dark Mode)" />
</Frame>
