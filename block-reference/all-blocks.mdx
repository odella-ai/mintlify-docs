...
<CardGroup cols={2}>
  ...
  <Card title="AI Filter" href="/block-reference/ai/ai-filter">
    Applies an AI call to each item in a list of values.
  </Card>
  ...
  <Card title="Analyze Table" href="/block-reference/ai/analyze-table">
    Analyzes a table using AI. Describe the analysis you want performed and the AI generates the code for you.
  </Card>
  ...
  <Card title="Create Chart" href="/block-reference/ai/create-chart">
    Creates a chart image using AI. Describe the chart you want using the input table and the AI generates the code to create the graph for you.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Match" href="/block-reference/logic/match">
    Configures any number of regular expressions, each corresponding to an output of the node. The output port of the first matching regex runs; all other output ports do not.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Draft" href="/block-reference/draft/draft">
    Drafts documents using a selection of pre-configured templates for common use cases.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Comment" href="/block-reference/advanced/comment">
    Adds a note to the graph without affecting execution.
  </Card>
