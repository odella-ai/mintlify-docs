...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/extract_json_light.png" alt="Extract JSON Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/extract_json_dark.png" alt="Extract JSON Block Screenshot" />
</Frame>
