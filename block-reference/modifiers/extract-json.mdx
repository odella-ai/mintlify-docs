...
<Frame>
  <img src="/block-reference/assets/extract_json_light.png" alt="Extract JSON Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/extract_json_dark.png" alt="Extract JSON Block Screenshot" className="hidden dark:block" />
</Frame>
