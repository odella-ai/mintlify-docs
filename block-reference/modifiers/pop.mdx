...
<Frame>
  <img src="/block-reference/assets/pop_light.png" alt="Pop Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/pop_dark.png" alt="Pop Block Screenshot" className="hidden dark:block" />
</Frame>
