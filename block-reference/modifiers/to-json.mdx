...
<Frame>
  <img src="/block-reference/assets/to_json_light.png" alt="To JSON Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/to_json_dark.png" alt="To JSON Block Screenshot" className="hidden dark:block" />
</Frame>
