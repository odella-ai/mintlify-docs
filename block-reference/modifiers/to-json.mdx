...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/to_json_light.png" alt="To JSON Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/to_json_dark.png" alt="To JSON Block Screenshot" />
</Frame>
