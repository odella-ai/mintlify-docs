...
<Frame>
  <img src="/block-reference/assets/extract_markdown_code_blocks_dark.png" alt="Extract Markdown Code Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/extract_markdown_code_blocks_light.png" alt="Extract Markdown Code Screenshot" className="hidden dark:block" />
</Frame>
