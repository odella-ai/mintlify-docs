...
<Frame>
  <img src="/block-reference/assets/shuffle_light.png" alt="Shuffle Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/shuffle_dark.png" alt="Shuffle Block Screenshot" className="hidden dark:block" />
</Frame>
