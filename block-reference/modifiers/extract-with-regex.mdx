...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/extract_with_regex_light.png" alt="Extract with Regex Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/extract_with_regex_dark.png" alt="Extract with Regex Block Screenshot" />
</Frame>
