...
<Frame>
  <img src="/block-reference/assets/index_light.png" alt="Index Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/index_dark.png" alt="Index Block Screenshot" className="hidden dark:block" />
</Frame>
