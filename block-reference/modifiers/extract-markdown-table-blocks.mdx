...
title: Extract Markdown Tables from Text
description: Use the Extract Markdown Table Blocks block to find markdown tables in text and convert them into structured Table values for workflows.
