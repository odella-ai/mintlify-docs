...
![Extract Markdown Table Blocks Screenshot](./assets/extract-markdown-table-blocks.png)

## Overview
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/extract_markdown_table_light.png" alt="Extract Markdown Table Blocks Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/extract_markdown_table_dark.png" alt="Extract Markdown Table Blocks Screenshot" />
</Frame>
