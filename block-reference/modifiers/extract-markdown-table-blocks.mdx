...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/extract_markdown_table_blocks_light.png" alt="Extract Markdown Table Blocks Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/extract_markdown_table_blocks_dark.png" alt="Extract Markdown Table Blocks Screenshot" />
</Frame>
