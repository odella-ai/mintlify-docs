...
<Frame>
  <img src="/block-reference/assets/flatten_light.png" alt="Flatten Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/flatten_dark.png" alt="Flatten Block Screenshot" className="hidden dark:block" />
</Frame>
