...
<Frame>
  <img src="/block-reference/assets/slice_light.png" alt="Slice Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/slice_dark.png" alt="Slice Block Screenshot" className="hidden dark:block" />
</Frame>
