...
<Frame>
  <img src="/block-reference/assets/filter_light.png" alt="Filter Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/filter_dark.png" alt="Filter Block Screenshot" className="hidden dark:block" />
</Frame>
...
- [Get Value Block](/block-reference/modifiers/get-value)
