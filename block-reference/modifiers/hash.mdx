...
<Frame>
  <img src="/block-reference/assets/hash_light.png" alt="Hash Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/hash_dark.png" alt="Hash Block Screenshot" className="hidden dark:block" />
</Frame>
