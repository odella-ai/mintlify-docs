...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/text_block_light.png" alt="Text Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/text_block_dark.png" alt="Text Block Screenshot" />
</Frame>
