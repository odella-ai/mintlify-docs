...
<Frame>
  <img src="/block-reference/assets/text_light.png" alt="Text Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/text_dark.png" alt="Text Block Screenshot" className="hidden dark:block" />
</Frame>
