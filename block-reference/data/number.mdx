...
<Frame>
  <img src="/block-reference/assets/number_light.png" alt="Number Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/number_dark.png" alt="Number Block Screenshot" className="hidden dark:block" />
</Frame>
