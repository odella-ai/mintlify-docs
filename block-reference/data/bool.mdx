...
<Frame>
  <img src="/block-reference/assets/bool_light.png" alt="Bool Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/bool_dark.png" alt="Bool Block Screenshot" className="hidden dark:block" />
</Frame>
