...
<Frame>
  <img src="/block-reference/assets/file_light.png" alt="File Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/file_dark.png" alt="File Block Screenshot" className="hidden dark:block" />
</Frame>
