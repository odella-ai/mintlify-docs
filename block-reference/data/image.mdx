...
<Frame>
  <img src="/block-reference/assets/image_light.png" alt="Image Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/image_dark.png" alt="Image Block Screenshot" className="hidden dark:block" />
</Frame>
...
- [Workflow data types](/workflow/data-types)
