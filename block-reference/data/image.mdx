...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/image_block_light.png" alt="Image Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/image_block_dark.png" alt="Image Block Screenshot" />
</Frame>
