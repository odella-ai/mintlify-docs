...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/object_block_light.png" alt="Object Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/object_block_dark.png" alt="Object Block Screenshot" />
</Frame>
