...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/date_block_light.png" alt="Date Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/date_block_dark.png" alt="Date Block Screenshot" />
</Frame>
