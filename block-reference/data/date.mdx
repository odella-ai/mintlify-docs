...
<Frame>
  <img src="/block-reference/assets/date_light.png" alt="Date Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/date_dark.png" alt="Date Block Screenshot" className="hidden dark:block" />
</Frame>
