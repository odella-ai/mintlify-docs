...
<Frame>
  <img src="/images/array-block.png" alt="Array Block Screenshot" />
</Frame>

## Inputs

<ParamField path="Input [i]" type="any">
  The ith input to be added to the array. Dynamic number of inputs based on how many connections there are.
</ParamField>

## Outputs

<ResponseField name="Output" type="any[]">
  The array created from the inputs. The output will be a single array containing all valid inputs.
</ResponseField>

<ResponseField name="Indices" type="number[]">
  The indices of the elements in the array. The output will be an array of numbers representing the array indices.
</ResponseField>
...
<Frame>
  <img src="/images/array-block-example-04.png" alt="Array Block Example 4" />
</Frame>
