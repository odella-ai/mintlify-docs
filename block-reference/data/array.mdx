...
<Frame className="block dark:hidden">
  <img src="/block_reference/assets/array_block_light.png" alt="Array Block Screenshot (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block_reference/assets/array_block_dark.png" alt="Array Block Screenshot (Dark Mode)" />
</Frame>
