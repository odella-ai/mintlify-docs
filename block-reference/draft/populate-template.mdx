...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/populate_template_light.png" alt="Populate Template Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/populate_template_dark.png" alt="Populate Template Block Screenshot" />
</Frame>
