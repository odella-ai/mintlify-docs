...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/draft_light.png" alt="Multi-Modal Draft Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/draft_dark.png" alt="Multi-Modal Draft Block Screenshot" />
</Frame>
