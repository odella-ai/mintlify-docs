...
<Frame className="block dark:hidden">
  <img src="/block_reference/assets/table_to_file_light.png" alt="Table to File Block Screenshot (Light Mode)" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block_reference/assets/table_to_file_dark.png" alt="Table to File Block Screenshot (Dark Mode)" />
</Frame>
