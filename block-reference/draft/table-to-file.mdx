...
<Frame>
  <img src="/block-reference/assets/table_to_file_light.png" alt="Table to File Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/table_to_file_dark.png" alt="Table to File Block Screenshot" className="hidden dark:block" />
</Frame>
