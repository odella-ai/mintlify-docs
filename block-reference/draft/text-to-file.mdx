...
<Frame className="block dark:hidden">
  <img src="/block-reference/assets/text_to_file_light.png" alt="Text to File Block Screenshot" />
</Frame>
<Frame className="hidden dark:block">
  <img src="/block-reference/assets/text_to_file_dark.png" alt="Text to File Block Screenshot" />
</Frame>
