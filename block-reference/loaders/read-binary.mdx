...
<Frame>
  <img src="/block-reference/assets/read_binary_light.png" alt="Read Binary Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/read_binary_dark.png" alt="Read Binary Block Screenshot" className="hidden dark:block" />
</Frame>
