...
<Frame>
  <img src="/images/read-binary-block.png" alt="Read Binary Block Screenshot" />
</Frame>

## Inputs

<ParamField path="File" type="file">
  The input file to be read as binary. Required.
</ParamField>

## Outputs

<ResponseField name="Binary Data" type="binary">
...
<Frame>
  <img src="/images/read-binary-example.png" alt="Read Binary Example" />
</Frame>
