...
<Frame>
  <img src="/block-reference/assets/read_table_light.png" alt="Read Table Block Screenshot" className="block dark:hidden" />
  <img src="/block-reference/assets/read_table_dark.png" alt="Read Table Block Screenshot" className="hidden dark:block" />
</Frame>
