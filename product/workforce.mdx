...
<Frame className="block dark:hidden">
  <img
    src="../assets/workforce_assistant_light.gif"
    alt="Workforce Overview (Light Mode)"
  />
</Frame>
<Frame className="hidden dark:block">
  <img
    src="../assets/workforce_assistant_dark.gif"
    alt="Workforce Overview (Dark Mode)"
  />
</Frame>
...
<Frame className="hidden dark:block">
  <img
    src="../assets/workforce_new_employee_dark.gif"
    alt="Workforce Overview (Dark Mode)" 
  />
</Frame>
...
<Frame className="block dark:hidden">
  <img
    src="../assets/workforce_add_application.gif"
    alt="Workflow Connect Workflows (Light Mode)"
  />
</Frame>
<Frame className="hidden dark:block">
  <img
    src="../assets/workforce_new_apps_dark.gif"
